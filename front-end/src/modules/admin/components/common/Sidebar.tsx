...
const SIDEBAR_ITEMS = [
	...
	{ name: "Users", icon: UsergroupAddOutlined, color: "#6366f1", href: "/admin/users" },
	{ name: "Role", icon: BookOutlined, color: "#6366f1", href: "/admin/roles" },
	{ name: "Banner", icon: FileImageOutlined, color: "#6366f1", href: "/admin/banners" },
	{ name: "Subscriptions", icon: SolutionOutlined, color: "#6366f1", href: "/admin/subscriptions" },
	{ name: "Watch History", icon: HistoryOutlined, color: "#6366f1", href: "/admin/watch-history" },
	{ name: "Rating", icon: StarOutlined, color: "#6366f1", href: "/admin/ratings" },
	{ name: "Favourite", icon: HeartOutlined, color: "#6366f1", href: "/admin/favourites" },
